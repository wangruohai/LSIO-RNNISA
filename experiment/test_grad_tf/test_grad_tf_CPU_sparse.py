...
if __name__ == "__main__":
    ...
    t_s = time()
    sim.simulate_and_bp_tf(I_S=I_S_0, GPU_flag=False, rand_seed=0) #you can use other random seeds
    print_run_time('Gradient Computation Using TensorFlow-CPU-sparse', t_s, 'second', 1)
